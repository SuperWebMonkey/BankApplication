...
import db.dao.IDrivingCompaniesDao;
import db.models.DrivingCompanies;
...
public class DrivingCompaniesDao implements IDrivingCompaniesDao {
    private static final Logger LOGGER = LogManager.getLogger(DrivingCompaniesDao.class);

    public List<DrivingCompanies> getAllEntities(){

        List<DrivingCompanies>  dcList = new ArrayList<>();
        ...
        try {
            ...
            while (rs.next()) {
                DrivingCompanies dc = new DrivingCompanies();
    ...
    public DrivingCompanies getEntityById(int id) {

        DrivingCompanies dc = null;
        Connection con = ConnectionPool.getInstance().getConnection();
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            if (rs.next()) {
                ...
                dc = new DrivingCompanies(drivingId, price, cityId);
            }
        } catch (Exception e) {
            LOGGER.error(e);
        } finally {
    ...
    public DrivingCompanies createEntity(DrivingCompanies dc) {
        Connection con = ConnectionPool.getInstance().getConnection();
    ...
    public void updateEntity(DrivingCompanies dc) {
