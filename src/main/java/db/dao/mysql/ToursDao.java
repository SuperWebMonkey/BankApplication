...
public class ToursDao implements IToursDao {
    private static final Logger LOGGER = LogManager.getLogger(ToursDao.class);

    public List<Tours> getAllEntities(){
    ...
    public Tours getEntityById(int id) {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            if (rs.next()) {
                ...
                tour = new Tours(tourId, tourName, hotelId,flightToId, flightFromId);
            }
        } catch (Exception e) {
            LOGGER.error(e);
        } finally {
    ...
    public Tours createEntity(Tours tour) {
        Connection con = ConnectionPool.getInstance().getConnection();
    ...
    public void updateEntity(Tours tour) {
